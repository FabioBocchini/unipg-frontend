		...
		return (
			<Form {...formItemLayout} onSubmit={this.handleSubmit}>
				...
				<Form.Item label="Matricola">
					...
					})(<Input onChange={(e) => this.setState({ matricola: e.target.value })} />)}
				</Form.Item>
				<Form.Item label="Nome">
					{getFieldDecorator('nome', {})(<Input onChange={(e) => this.setState({ nome: e.target.value })} />)}
				</Form.Item>
				<Form.Item label="Cognome">
					{getFieldDecorator('cognome', {})(
						<Input onChange={(e) => this.setState({ cognome: e.target.value })} />
					)}
				</Form.Item>
