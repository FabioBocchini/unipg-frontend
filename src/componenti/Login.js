...
class LoginComponent extends Component {
    ...
    handleLoginClick() {
        if (this.state.profCheck === false)
            this.checkLoginInfoStudente(this.state.email, this.state.password)
        else
            this.checkLoginInfoProfessore(this.state.email, this.state.password)
    }
    ...
    render(){
        ...
        return(
            ...
            <Form.Item>
                ...
                <Button type="primary" htmlType="submit" className="login-form-button" onClick={this.handleLoginClick}>
                    Log in
                </Button>
